...
/* This is written to run on an TTGO T4 v1.3 w/TTF backpack (dimmable) ESP32.
   ...
   NOT: I use WiFiManager named "ESPWiFiMgr".  The first time you runas it, connect
   ...
   Gets NTP time.  No auto-DST code at this time.
...
//#include <Custom_Setups/Setup6A_ESP_SPI_ILI9486.h>     // Setup file for ILI9486 SPI serial on ESP32/ESP8266
#define TARGET_DISPLAY ILI9486  // Can only do screen calibration on ILI9486 at the moment.
//#define GET_XRATE  // Commented: Don't get X Rate on this unit.  In force, of course, lets it happen.
#define DO_WEDGE_HANDS
...
#include <Adafruit_FT6206.h>  // For touch on WT32-SC01 (non-plus version)
Adafruit_FT6206 ts = Adafruit_FT6206();

#include <ezTime.h>

Timezone homeTime;  // Your local time used for most displays.

// If this is changed, also go to setup() around line 118 and coordinate.
// Search for "homeTime.setLocation(" to find the code.
...
Timezone dtzTopCity;          // Dual Time Zone top city
String topCity = "Benicia";
Timezone dtzBottomCity;
String bottomCity = "San Clemente, Tarlac, PI";  // Dual Time Zone bottom city
// api keys for currency conversion.
// There are 2.2726578844967513453552415636e+57 combinations for the apikey.
//String apikey = "23TJj8EbyRWec1MPBECv5kLI7zAZNh3C";  // Created after expiring the first one.
...
Timezone dtzTopCity;          // Dual Time Zone top city
String topCity = "Bangui";
Timezone dtzBottomCity;
String bottomCity = "Benicia";  // Dual Time Zone bottom city
// api keys for currency conversion.
// There are 2.2726578844967513453552415636e+57 combinations for the apikey.
...
long unsigned NTP_Update = 86578;
...
char  prevTopDate[100], prevBottomDate[100];  // For comparing to save some updating/flicker
...
int prev_month = -1, prev_DOM = -1, prev_DOW = -1;
int SS_Pay_Wed_DOM;
...
unsigned long loopWait, last_sec = 0;
...
//int T_initialX, T_initialY;
//int T_endingX = 0, T_endingY = 0;
//int T_distanceX, T_distanceY;
